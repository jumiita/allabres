            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var q = this.horizontalPadding, y = this.verticalPadding, B = this.pointerWidth,
                        u = this.pointerOrientation, v = this.cornerRadius, w = c.fontFamily, A = this.fontSize;
                    ...
                    0 < this.animationDuration && !e && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY, NaN, !0), f.animate({translate: x - g + "," + A}, b, "easeOutSine"), n && (C.left = this.prevTX + "px", C.top = this.prevTY + "px", this.xAnim = c.animate({node: n}, "left", this.prevTX, m, b, "easeOutSine", "px"), this.yAnim = c.animate({node: n}, "top", this.prevTY, h, b, "easeOutSine", "px")));
                    this.prevX = x - g;
                    this.prevY = A;
                    this.prevTX = m;
                    this.prevTY = h
...
(function () {
    ...
    d.AmMap = d.Class({
        inherits: d.AmChart, construct: function (a) {
            ...
            var g = this.realWidth, f = this.realHeight, k = this.mapSet.scale, h = this.zoomControl,
            ...
            var a = d.degreesToRadians(this.dataProvider.leftLongitude),
                ...
                l = this.dpProjectionFunction(a, f)[0], m = this.dpProjectionFunction(b, f)[0],
                c = d.equirectangular(g, c), e = d.equirectangular(g, e), k = (c[1] - e[1]) / (k - h),
                a = d.equirectangular(a, f), b = d.equirectangular(b, f), l = (a[0] - b[0]) / (l - m);
            ...
            if (f = c.invert) {
                var k = this.dataProvider.leftLongitude, h = this.dataProvider.rightLongitude,
                    l = this.dataProvider.topLatitude, m = this.dataProvider.bottomLatitude, n = k + (h - k) / 2,
                    p = l + (m - l) / 2, l = d.radiansToDegrees(c(d.degreesToRadians(n), d.degreesToRadians(l))[1]),
    ...
    d.ZoomControl = d.Class({
        construct: function (a) {
            ...
            var g = c.buttonSize, f = c.zoomControlEnabled, k = c.panControlEnabled, h = c.buttonFillColor,
                ...
                B = c.minZoomLevel, u = c.maxZoomLevel, v = c.buttonIconAlpha, w = c.buttonIconColor,
...
(function () {
    ...
    d.winkel3.invert = function (a, b) {
        ...
        do var k = Math.cos(e), h = Math.sin(e), l = Math.sin(2 * e), m = h * h, n = k * k, p = Math.sin(c),
            r = Math.cos(c / 2), t = Math.sin(c / 2), q = t * t, y = 1 - n * r * r,
            B = y ? d.acos(k * r) * Math.sqrt(u = 1 / y) : u = 0, u, y = .5 * (2 * B * k * t + c / f) - a,
            v = .5 * (B * h + e) - b, w = .5 * u * (n * q + B * k * r * m) + .5 / f, A = u * (p * l / 4 - B * h * t),
